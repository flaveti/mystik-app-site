    ...
    <div className="min-h-screen pt-24 pb-16 bg-gradient-to-b from-background to-muted/20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl mb-4">{t('legal.privacy.title')}</h1>
        ...
        >
          <div className="space-y-8 text-muted-foreground">
            <section>
              <h2 className="text-2xl text-foreground mb-4">{t('legal.privacy.section1.title')}</h2>
              <p>{t('legal.privacy.section1.content')}</p>
            </section>

            <section>
              <h2 className="text-2xl text-foreground mb-4">{t('legal.privacy.section2.title')}</h2>
              <p>{t('legal.privacy.section2.content')}</p>
            </section>

            <section>
              <h2 className="text-2xl text-foreground mb-4">{t('legal.privacy.section3.title')}</h2>
              <p>{t('legal.privacy.section3.content')}</p>
            </section>

            <section>
              <h2 className="text-2xl text-foreground mb-4">{t('legal.privacy.section4.title')}</h2>
              <p>{t('legal.privacy.section4.content')}</p>
            </section>

            <section>
              <h2 className="text-2xl text-foreground mb-4">{t('legal.privacy.section5.title')}</h2>
              <p>{t('legal.privacy.section5.content')}</p>
            </section>

            <section>
              <h2 className="text-2xl text-foreground mb-4">{t('legal.privacy.section6.title')}</h2>
              <p>{t('legal.privacy.section6.content')}</p>
            </section>

            <section>
              <h2 className="text-2xl text-foreground mb-4">{t('legal.privacy.section7.title')}</h2>
